...
def buffer_analysis(address):
    ...
    if coordinates:
        ...
        # 雙北飲料店
        drink_df = gpd.read_file("./gis/Dataset/drink.csv")
        ...
        # 雙北火車
        train_df = gpd.read_file("./gis/Dataset/train.csv")
        ...
        # 雙北公車站
        bus_df = gpd.read_file("./gis/Dataset/bus.csv")
        ...
        # 雙北youbike站
        youbike_df = gpd.read_file("./gis/Dataset/youbike.csv")
        ...
        # 雙北公園
        park_df = gpd.read_file("./gis/Dataset/park.csv")
        ...
        # 雙北夜市
        night_market_df = gpd.read_file("./gis/Dataset/night_market.csv")
        ...
        # 雙北捷運
        mrt_df = gpd.read_file("./gis/Dataset/mrt.csv")
        ...
        sports_facilities_df = gpd.read_file(
            "./gis/Dataset/sports_facilities.csv"
        )
        ...
        # 雙北電影院
        movie_theater_df = gpd.read_file("./gis/Dataset/movie_theater.csv")
        ...
        # 雙北學校
        school_df = gpd.read_file("./gis/Dataset/school.csv")
        ...
        # 雙北醫院
        hospital_df = gpd.read_file("./gis/Dataset/hospital.csv")
...
def user_data(address_district_info):
    ...
    # 地區薪資中位數
    salary_df = pd.read_csv("./gis/Dataset/area/salary.csv")
    ...
    # 地區平均年齡
    age_df = pd.read_csv("./gis/Dataset/area/age.csv")
    ...
    people_flow_mean_df = pd.read_csv(
        "./gis/Dataset/area/people_flow_mean.csv"
    )
    ...
    # 道路面積比例
    road_area_df = pd.read_csv("./gis/Dataset/area/Road_area_ratio.csv")
    ...
    knock_down_price_df = pd.read_csv(
        "./gis/Dataset/area/knock_down_price_mean.csv"
    )
    ...
    star_mean_df = pd.read_csv(
        "./gis/Dataset/area/star_mean.csv"
    )
    star_mean_mask = (
...
def drink_top10_brand(address):
    ...
    if coordinates:
        ...
        # 載入各品牌地點資料
        COCO_df = gpd.read_file("./gis/Dataset/top10/COCO.csv")
        ...
        五桐號_df = gpd.read_file("./gis/Dataset/top10/五桐號.csv")
        ...
        五十嵐_df = gpd.read_file("./gis/Dataset/top10/五十嵐.csv")
        ...
        大苑子_df = gpd.read_file("./gis/Dataset/top10/大苑子.csv")
        ...
        先喝道_df = gpd.read_file("./gis/Dataset/top10/先喝道.csv")
        ...
        麻古茶坊_df = gpd.read_file("./gis/Dataset/top10/麻古茶坊.csv")
        ...
        一沐日_df = gpd.read_file("./gis/Dataset/top10/一沐日.csv")
        ...
        春水堂_df = gpd.read_file("./gis/Dataset/top10/春水堂.csv")
        ...
        清心福全_df = gpd.read_file("./gis/Dataset/top10/清心福全.csv")
        ...
        珍煮丹_df = gpd.read_file("./gis/Dataset/top10/珍煮丹.csv")
